"""Tests for STOLID1xx error codes (patch/mock related)."""
...
class TestSTOLID102Import(unittest.TestCase):
    """Tests for STOLID102: patch import detection."""
    ...
    def test_import_patch_from_unittest_mock(self) -> None:
        ...
        assert_that(codes, has_item("STOLID102"))
    ...
    def test_patch_aliased_import(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that("STOLID102" in codes, equal_to(True))
    ...
    def test_import_patch_among_multiple(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        stolid102_count = codes.count("STOLID102")
        assert_that(stolid102_count, equal_to(1))


class TestSTOLID102Usage(unittest.TestCase):
    """Tests for STOLID102: patch usage detection."""
...
class TestSTOLID102EdgeCases(unittest.TestCase):
    """Tests for STOLID102: edge cases and non-matches."""
    ...
    def test_with_statement_non_call(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that("STOLID102" in codes, equal_to(False))
