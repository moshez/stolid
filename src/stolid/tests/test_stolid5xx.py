"""Tests for STOLID5xx error codes (dataclass related)."""
...
class TestSTOLID501FrozenDataclass(unittest.TestCase):
    """Tests for STOLID501: Dataclass missing frozen=True."""
    ...
    def test_dataclass_no_frozen(self) -> None:
        ...
        assert_that(codes, has_item("STOLID501"))
    ...
    def test_dataclass_frozen_true(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that("STOLID501" in codes, equal_to(False))


class TestSTOLID502SlotsDataclass(unittest.TestCase):
    """Tests for STOLID502: Dataclass missing slots=True."""
    ...
    def test_dataclass_no_slots(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that(codes, has_item("STOLID502"))
    ...
    def test_dataclass_slots_true(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that("STOLID502" in codes, equal_to(False))


class TestSTOLID503KwOnlyDataclass(unittest.TestCase):
    """Tests for STOLID503: Dataclass missing kw_only=True."""
    ...
    def test_dataclass_no_kw_only(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that(codes, has_item("STOLID503"))
    ...
    def test_dataclass_kw_only_true(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that("STOLID503" in codes, equal_to(False))
...
class TestDataclassVariants(unittest.TestCase):
    ...
    def test_dataclass_with_all_flags(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        lps50x = [c for c in codes if c.startswith("STOLID50")]
