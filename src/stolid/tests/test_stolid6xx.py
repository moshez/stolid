"""Tests for STOLID6xx error codes (code limits)."""
...
class TestSTOLID601FunctionLineLimit(unittest.TestCase):
    """Tests for STOLID601: Function exceeds line limit."""
    ...
    def test_function_within_limit(self) -> None:
        ...
        assert_that("STOLID601" in codes, equal_to(False))
    ...
    def test_function_exceeds_limit(self) -> None:
        ...
        code = "\n".join(lines)
        codes = get_error_codes(code)
        assert_that(codes, has_item("STOLID601"))
...
class TestSTOLID602ArgumentLimit(unittest.TestCase):
    """Tests for STOLID602: Function exceeds argument limit."""
    ...
    def test_function_within_limit(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that("STOLID602" in codes, equal_to(False))
    ...
    def test_function_exceeds_limit(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that(codes, has_item("STOLID602"))
...
class TestSTOLID603ClassMethodLimit(unittest.TestCase):
    """Tests for STOLID603: Class exceeds method limit."""
    ...
    def test_class_within_limit(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that("STOLID603" in codes, equal_to(False))
    ...
    def test_class_exceeds_limit(self) -> None:
        ...
        code = "\n".join(lines)
        codes = get_error_codes(code)
        assert_that(codes, has_item("STOLID603"))
...
class TestSTOLID604ModuleLineLimit(unittest.TestCase):
    """Tests for STOLID604: Module exceeds line limit."""
    ...
    def test_module_within_limit(self) -> None:
        ...
        """
        codes = get_error_codes(code)
        assert_that("STOLID604" in codes, equal_to(False))
    ...
    def test_module_exceeds_limit(self) -> None:
        ...
        code = "\n".join(lines)
        codes = get_error_codes(code)
        assert_that(codes, has_item("STOLID604"))
    ...
    def test_error_message_includes_line_count(self) -> None:
        ...
        messages = [msg for _, _, msg in errors if "STOLID604" in msg]
