"""Tests for LPS3xx error codes (init, private methods, public access)."""
...
class TestLPS303Detection(unittest.TestCase):
    """Tests for LPS303: Detection of methods that only access public members."""
...
class TestLPS303Exemptions(unittest.TestCase):
    """Tests for LPS303: Exemptions from public access check."""
